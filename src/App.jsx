...
import BenchmarkChart, { BenchmarkSelector, BENCHMARK_PRESETS } from './components/BenchmarkChart';
        ...
        <div className="animate-fade-in">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            <SummaryCard icon={DollarSign} label={currency === 'KRW' ? '최종 가치' : 'Final Value'}
              value={fmt(summary.finalValue, currency)} sub={`from ${fmt(summary.invested, currency)}`}
            ...
            <SummaryCard icon={positive ? TrendingUp : TrendingDown} label={currency === 'KRW' ? '총 손익' : 'Total P&L'}
              value={fmt(summary.totalPL, currency)} color={positive ? 'text-terminal-green' : 'text-terminal-red'} delay={50} />
